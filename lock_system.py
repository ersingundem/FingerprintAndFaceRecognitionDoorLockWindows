...
but3 = tk.Button(window, text="Open the Lock", width=30, font=("Ariel Bold", 15), bg='orange', fg='white',
                 command=fingerprints)
but3.place(x=100, y=200)
but4 = tk.Button(window, text="Control Panel", width=30, font=("Ariel Bold", 15), bg='orange', fg='white',
                 command=Loginform)
